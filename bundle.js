...
((s,r,h)=>{
    ...
    var k = new ((()=>{
        ...
        return _createClass(e, [{
            ...
            value(e, t) {
				...
				J.ogarWS2 = null) : (
				ae.connectedIndex = 1,
				J.ogarWS2 = this.ws = this.connect(),
				...
				Js.saigoWS = null,
				ses.teammates.clear()) : (Js.saigoWS = this.ws = this.connect(),
    ...
    q = new ((()=>{
        ...
        return _createClass(e, [{
            ...
            value(e) {
                ...
                G.reset(),
                this.address = e,
                this.Tab1 = this.ws = this.connect(),
                ...
                k.multiboxMode === "on" && (this.Tab2 = this.ws = this.connect(),
                ...
                this.Tab3 = this.ws = this.connect(),
    ...
    J = new ((()=>{
        ...
        return _createClass(e, [{
            ...
            value() {
                const e = this;
                this.ogarWS1 = this.ws = this.connect(),
                ...
                k.multiboxMode === "on" && (this.ogarWS2 = this.ws = this.connect(),
			...
			value(tab) {
				...
				this.ogarWS2 = null,
				this.ogarWS2 = this.ws = this.connect(),
                this.ogarWS2.binaryType = "arraybuffer",
                this.ogarWS2.onopen = (()=>e.onOpen(2)),
                this.ogarWS2.onmessage = (t=>e.onMessage(t, 2)),
                this.ogarWS2.onclose = (()=>e.onClose(2)),
    ...
    Js = new ((()=>{
        ...
        return _createClass(e, [{
            ...
            value() {
                const e = this;
                k.spySaigo === "on" && (this.saigoWS = this.ws = this.connect(),
			...
			value() {
				...
				this.saigoWS.close(),
				this.saigoWS = null,
				this.saigoWS = this.ws = this.connect(),
                this.saigoWS.binaryType = "arraybuffer",
                this.saigoWS.onopen = (()=>e.onOpen()),
                this.saigoWS.onmessage = (t=>e.onMessage(t)),
                this.saigoWS.onclose = (()=>e.onClose()),
    ...
    le = new ((()=>{
        function e() {
            ...
            r.ajax("https://raw.githubusercontent.com/ratzambibi/agarshit/refs/heads/main/agario.js", {
                error: function() {
